                ...
                default:
                    {
                        ...
                        const isAppDevServer = utils_1.isHttpUrl(config.appArtifactLocation);
                        // build app
                        if (isPackageJsonExists) {
                            ...
                            utils_1.logger.silly(chalk_1.default.yellow(`Skipping app build: App served from ${config.appArtifactLocation}`), "npm");
                        }
                        else {

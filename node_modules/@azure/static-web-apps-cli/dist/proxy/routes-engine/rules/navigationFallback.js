...
const navigationFallback = async (req, _res, navigationFallback) => {
    ...
    const filepath = path_1.default.join(process.env.SWA_CLI_APP_ARTIFACT_LOCATION, filename);
    ...
    const isMatchedFilter = navigationFallback.exclude.some((filter) => {
        ...
        if (originlUrl === null || originlUrl === void 0 ? void 0 : originlUrl.startsWith(globSegments.base)) {
